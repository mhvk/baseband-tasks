        ...
        **kwargs
        ...
        def __call__(self, time_data=None, freq_data=None, axis=0,
            ...
            freq_data : `~numpy.ndarray`, dict, or None
                ...
                If not given, it is derived from ``time_data``.  If both are
                given, they will be checked for consistency.
            axis : int, optional
            ...
            class PyfftwFFT(FFTBase):
                ...
                To use, first initialize an instance, and then call the
                instance to perform the transform.
                ...
                def __init__(self, direction='forward'):
                    ...
                    # we'll be replacing those each time we transform.
                ...
                def __eq__(self, other):
                    # Assumes that class names are unique, which is the case
